...
# Submission #3 - Needed more comments!
...
""""
 validateInput: 
    Pass a prompt and the acceptable values.  Return an acceptable answer. This routine will always return a string
    It gaurentees the user will cycle thru only acceptable values so the rest of the program can behave reliably.
"""
...
def init_quiz_statement(difficulty_level):
    ...
    if difficulty_level == 'Easy':
        ...
        statement = statement + "They ___3___  earthquakes when they travel ___4___.  "      
...
# Input: (difficulty_level) A string that identifies the difficulty level
# Returns: All the answers for that difficulty level  
...
def init_quiz_answers(difficulty_level):
    ...
    if difficulty_level == 'Extreme': return [4,'Dugtrio','three','trigger','underground']
...
# put this inside of a function to meet the 'automating repetition' specification.
# This sets up and initializes the gameplay
